 const create = async (params, credentials, post) => {
    try {
      let response = await fetch('https://mern-social-app.herokuapp.com/api/posts/new/'+ params.userId, {
        method: 'POST',
        headers: {
  ...
  const listByUser = async (params, credentials) => {
    try {
      let response = await fetch('https://mern-social-app.herokuapp.com/api/posts/by/'+ params.userId, {
        method: 'GET',
        headers: {
          'Accept': 'application/json',
          'Content-Type': 'application/json',
  ...
  const remove = async (params, credentials) => {
    try {
      let response = await fetch('https://mern-social-app.herokuapp.com/api/posts/' + params.postId, {
        method: 'DELETE',
        headers: {
          'Accept': 'application/json',
          'Content-Type': 'application/json',
