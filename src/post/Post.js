...
import { UserApiConsumer } from './../Context';
...
export default function Post (props){
  ...
  const deletePost = () => {   
    ...
    return (
      ...
      <UserApiConsumer>
            {(value)=>{
            //let photoUrl = value.value.filter((res)=>res._id===props.post.postedBy._id)[0].photo
       return (<CardHeader
            avatar={
              <Avatar src={props.post.postedBy.photo}/>
            }
         ...
         { props.post.photo &&
            (<div className={classes.photo}>
              <img
                ...
                src={props.post.photo} alt ="user_ups"
                />
            </div>)}
        </CardContent>
        <CardActions>
